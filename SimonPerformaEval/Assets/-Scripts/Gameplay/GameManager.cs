...
public class GameManager : CoroutineStateMachine
{
    ...
    /// </summary>
    protected IEnumerator PreGameState(MethodInfo thisMethod)
    {
    ...
    /// <summary>
    /// This state plays the sequence to the player
    /// </summary>
    protected IEnumerator PlaySequence(MethodInfo thisMethod)
    {
    ...
    /// <summary>
    /// This state watches the users input and changes states when the player has matched the entire sequence 
    /// </summary>
    protected IEnumerator WaitForUserInput(MethodInfo thisMethod)
    {
        _inputReady = true;
